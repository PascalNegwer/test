...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cookie_js__ = __webpack_require__(18);
  ...
  routes: [
    {
      ...
      component: function (resolve) {
        __webpack_require__.e/* require */(2).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(20)]; ((resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe)
      }
    },
    {
      path: '/signup',
...
function guardRoute(to, from, next) {
  let sessionToken = __WEBPACK_IMPORTED_MODULE_2__cookie_js__["a" /* default */].getCookie('sessionToken');
  ...
  if (!sessionToken) {
    ...
    user.requestSessionToken(true, {
      onOk: result => {
        __WEBPACK_IMPORTED_MODULE_2__cookie_js__["a" /* default */].setCookie('sessionToken', result['sessionToken']);
        router.push('/');
      },
      onError: error => {
        redirectToLogin(to, next);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_router_js__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7ba5bd90_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(16);
